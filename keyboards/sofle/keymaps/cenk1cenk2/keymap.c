...
KC_CAPS,            UG_HUEU,              UG_SATU,              UG_VALU,            UG_NEXT,             KC_NO,                                                         KC_BRID,             KC_MPRV,            KC_MPLY,              KC_MNXT,            KC_NO,               KC_NO,
KC_NO,              UG_HUED,              UG_SATD,              UG_VALD,            UG_PREV,             KC_NO,               KC_TRNS,             KC_TRNS,             KC_NO,               KC_NO,              KC_NO,                KC_NO,              KC_NO,               KC_NO,
                    KC_TRNS,              KC_TRNS,              KC_TRNS,            KC_TRNS,             KC_TRNS,                                                       KC_TRNS,             KC_TRNS,            KC_TRNS,              KC_TRNS,            KC_TRNS
)
//                  |                    |                    |                    |                    |                    |                    |                    |                    |                    |                    |                    |                    |
};
